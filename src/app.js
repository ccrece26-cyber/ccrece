...
app.get('/api/admin/anticipos', admin.listAnticipos);
app.get('/api/admin/anticipos/dias-registro', admin.listAnticiposDiasRegistro);
app.get('/api/admin/anticipos/sin-historial', admin.listAnticiposSinHistorial);
app.post('/api/admin/anticipos/backfill', admin.backfillHistorialAnticipo);
app.post('/api/admin/anticipos/:id/revertir', admin.revertirAnticipoAdmin);
app.post('/api/admin/anticipos/:id/corregir', admin.corregirAnticipoAdmin);
app.get('/api/admin/prestamos/:id/cuotas-pendientes', admin.listCuotasPendientesPrestamo);
app.post('/api/admin/cuotas/:id/ajustar-fecha', admin.ajustarFechaCuotaAdmin);
...
app.get('/api/cobrador/cartera-version/:cobradorId', cobrador.carteraVersion);
