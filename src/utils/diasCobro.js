...
/** Compat cobro flexible: día habitual o día de desembolso excluido. Sin feriados/anticipos. */
const debeIncluirEnAgenda = (fechaRefISO, prestamo, _opts = {}) =>
  debeSugerirCobroEnFecha(fechaRefISO, prestamo);
